          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(color:  DrummTheme.primaryTextColor(context), width: 1)),
              child: Row(
                ...
                builder: (BuildContext context) {
                  return Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: AlertDialog(
                        backgroundColor: DrummTheme.primaryItemColor(context),
                        surfaceTintColor: DrummTheme.primaryItemColor(context),
                        title: Text(
          ...
          return Padding(
            ...
            child: ClipRRect(
              ...
              child: AlertDialog(
                ...
                title: Text(
                    "Please sign in again to continue with account deletion. Select one of the following to continue"),
                actions: [
                  GestureDetector(
                    onTap: () {
                      signInWithGoogle();
