...
class VectorSearchAndLoadRecommendedArticlesUseCase
    implements UseCase<DataState<bool>, GetArticlesParams> {
  final ArticleRepository articleRepository;

  VectorSearchAndLoadRecommendedArticlesUseCase(this.articleRepository);

  @override
  Future<DataState<bool>> call({GetArticlesParams? params}) async {
    try {
      var articleDataState = await articleRepository.vectorSearchAndLoadRecommendedArticles(params!);
