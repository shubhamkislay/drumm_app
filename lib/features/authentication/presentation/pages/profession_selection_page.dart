...
import 'package:drumm_app/custom/ProfessionChipSelectionWidget.dart';
...
class ProfessionSelectionPage extends StatefulWidget {
  Drummer? drummer;
  ProfessionSelectionPage({super.key, this.drummer});

  @override
  State<ProfessionSelectionPage> createState() => _ProfessionDetailsPageState();
}

class _ProfessionDetailsPageState extends State<ProfessionSelectionPage> {
