...
class PerformVectorSearchUseCase
    implements UseCase<DataState<ArticleListEntity>, GetArticlesParams> {
  final ArticleRepository articleRepository;

  PerformVectorSearchUseCase(this.articleRepository);
  ...
  Future<DataState<ArticleListEntity>> call({GetArticlesParams? params}) async {
    try {
      ...
      var articleDataState = await articleRepository.performVectorSearch(params!);
