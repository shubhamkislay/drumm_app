...
const APP_FONT_LIGHT = "serif";//"poppinslight";//"robotolight";chakrapetchlight
const APP_FONT_MEDIUM = "serif";//"poppinsmedium";//"robotomedium";chakrapetchmedium
const APP_FONT_BOLD = "serif";//"poppinsbold";//"robotobold";chakrapetchbold
