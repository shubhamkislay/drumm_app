...
const APP_FONT_LIGHT = "";//"poppinslight";//"robotolight";chakrapetchlight
const APP_FONT_MEDIUM = "";//"poppinsmedium";//"robotomedium";chakrapetchmedium
const APP_FONT_BOLD = "";//"poppinsbold";//"robotobold";chakrapetchbold
