...
class TransparentSlider extends StatefulWidget {
  ...
  @override
  _TransparentSliderState createState() => _TransparentSliderState();
}

class _TransparentSliderState extends State<TransparentSlider> {
