...
class NewsDiscoveryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<RemoteBandsBloc, RemoteBandsState>(
        builder: (BuildContext context, bandState) {
          return NotificationListener<ScrollNotification>(
            onNotification: (scrollNotification) {
              if (scrollNotification.metrics.axisDirection == AxisDirection.down && scrollNotification is ScrollUpdateNotification &&
