    ...
    return Scaffold(
      ...
      body: BlocBuilder<SignInBloc,SignInState>(
        builder: (BuildContext context, state) {
          String apple = (state is SignInIdle) ? "Continue with Apple" : "Signing in with apple...";
          String google = (state is SignInIdle) ? "Continue with Google" : "Signing in with google...";
          bool  showAppleSignInButton = (state is SignInIdle) ? true : (state is SignInWithApple) ?true:false;
          bool  showGoogleSignInButton = (state is SignInIdle) ? true : (state is SignInWithGoogle) ?true:false;
          if(state is SignInCompleted) context.go(state.route??"/");
          ...
          return Column(
            ...
            children: [
              ...
              SizedBox(height: 12,),
              if(showGoogleSignInButton) GestureDetector(
                onTap: (){
